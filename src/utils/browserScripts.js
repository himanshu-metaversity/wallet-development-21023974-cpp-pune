...
export const JS_POST_MESSAGE_TO_PROVIDER = (message) =>
  `ReactNativeWebView.onMessage(${JSON.stringify(message)});`;

export const SET_NETWORK_ID = (networkId) =>
  `window.humaniqAppNetworkId=${networkId};`;
