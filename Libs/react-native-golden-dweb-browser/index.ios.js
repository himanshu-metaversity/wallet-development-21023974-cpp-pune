...
export default class GoldenDWebBrowser extends Component {
  ...
  render() {
    const {
      ...
      addressHex,
      network,
      infuraAPIKey = "9659c2e2541b487ba66268b2207799f6",
      jsContent,
      onLoadEnd,
      onLoadStart,
      onProgress,
    } = this.props;
    console.log("testData", { uri, addressHex, network, jsContent });
    return (
      <View style={[styles.container, style]}>
        <WKWebView
          ...
          source={{ uri }}
          onMessage={(e) => {
            this._onMessage(e.nativeEvent);
          }}
          injectJavaScript={getJavascript(
            addressHex,
            network,
            infuraAPIKey,
            jsContent
  ...
  return `
    ...
    function getInfuraRPCURL(chainID, apiKey) {
      switch(chainID) {
        ...
        case 42: return 'https://goerli.infura.io/' + apiKey;
      }
    ...
    function getInfuraWSSURL(chainID, apiKey) {
      switch(chainID) {
        ...
        case 42: return 'wss://goerli.infura.io/ws/' + apiKey;
      }
